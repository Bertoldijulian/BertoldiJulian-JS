...
let buton = document.getElementById("reservar");
buton.addEventListener("click", respuestaClick)
buton.onclick = () => {console.log("hizo click")}
function respuestaClick() {
    console.log("quiere reservar")
} */
...
function enviarFormulario (e) {
    e.preventDefault(); {
        console.log("El usuario envio el formulario");
    }
}

let primero = document.getElementById("apellido");
let segundo = document.getElementById("nombre");

primero.onchange = () => {console.log("apellido")};
segundo.onchange = () => {console.log("nombre")};